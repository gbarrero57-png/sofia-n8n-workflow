#!/usr/bin/env python3
"""Fix all Supabase Code nodes - use this.helpers.httpRequest instead of fetch"""
...
# ============================================================
# Node code definitions using this.helpers.httpRequest()
# ============================================================
...
BUSCAR_KB_CODE = (
    ...
    '}\n'
    '\n'
    'const data = Object.assign({}, $json, { kb_results: results, kb_status: "ok" });\n'
    'return [{ json: data }];'
)
